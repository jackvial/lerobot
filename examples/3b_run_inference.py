...
if __name__ == "__main__":
    ...
    parser.add_argument('--inference_time', type=int, default=60, help='Duration of inference in seconds')
    ...
    policy = DiffusionPolicy.from_pretrained(args.modelname_or_path)
